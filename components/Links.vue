<template>
  <section class="section section--highlighted" id="links">
    <div class="section__inner">
      ...
      <p><a href="https://www.fronta11y.org/barrierefreiheit-fuer-produkte-und-dienstleistungen-der-european-accessibility-act/" hreflang="de">A detailed summary of the directive in German language can be found in this article from Anne-Marie Nebe.</a></p>
    </div>
  </section>
</template>
